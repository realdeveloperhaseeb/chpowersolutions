    ...
    <section className="container-x flex justify-center py-16">
      <Reveal className="w-full max-w-md">
        <div className="card p-8">
          ...
          <p className="mt-1 text-sm text-slate-500">Sign up to place orders and track them.</p>
          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            ...
            <input required type="password" placeholder="Password (min 6 characters)" className={field} value={form.password} onChange={set("password")} />
